package me.braun.identityservice.config.security.jwt;
...
public class JwtProcessor {
    ...
    private @NotNull Collection<? extends GrantedAuthority> getAuthorities(String jwt) {
    ...
    Authentication getAuthentication(String jwt) {
        UserDetails userDetails = new UserPrincipal(Account.builder().email(getUsername(jwt)).build());
